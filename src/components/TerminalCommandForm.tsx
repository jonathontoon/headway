  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1 min-w-[8ch] ml-[1ch]">
        {/*
          iOS Safari can paint a native insertion caret even when the input is
          transparent. Give the native control a real color that matches the
          terminal background, so its text/caret blend behind the custom cursor.
        */}
        <input
          ref={inputRef}
          id="terminal-command"
